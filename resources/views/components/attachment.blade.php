  ...
  <div class="row row-cols-md-6 row-cols-sm-3 g-4 w-100 ">
    @foreach ($attachments as $attachment)
      <div class="col pe-auto attachment-div">
        <div class="card attachment-card attachement-card-{{ $attachment->id }}" title="{{ $attachment->file_name }}"
          data-value="{{ $attachment->id }}" data-file="{{ $attachment->file_path }}">
          <img src="{{ Storage::url($attachment->file_path) }}" class="card-img-top p-2" height="130" width="190"
            alt="...">
